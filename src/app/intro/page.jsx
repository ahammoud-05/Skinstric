...
const Intro = () => {
  ...
  const handleStepTwo = async () => {
    if (step === 2) {
      if (typeof location === 'string' && location.trim() !== '' && isNaN(location)) {
      ...
      <div className="min-h-screen flex flex-col">
          ...
          { step === 1 ? (
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <input
                ...
                className="text-4xl w-[395px] 
                text-center outline-none border-b border-black max-w-md 
                placeholder:text-black placeholder:font-light focus:placeholder-transparent
                tracking-tighter"
              />
            </div>
          </div>
        ...
        >
          ...
          {(name && step === 1) || (location && step === 2) ? (  
            <div onClick={step === 1 ? handleStepOne : handleStepTwo} className="flex items-center gap-2 cursor-pointer">
              <p className="whitespace-nowrap text-gray-700 font-semibold">PROCEED</p>
              <Image className="rotate-180" src="/assets/ButtonIcon.png" alt="back-button" width={44} height={44} />
            </div>
          ) : null}
        </div>
      </div>
